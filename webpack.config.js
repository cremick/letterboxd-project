...
let entry = "./letterboxdStats/js/main.jsx";
if (existsSync("./letterboxdStats/js/main.tsx")) {
  entry = "./letterboxdStats/js/main.tsx";
}
...
module.exports = {
  ...
  entry,
  output: {
    path: path.join(__dirname, "/letterboxdStats/static/js/"),
    filename: "bundle.js",
  },
  devtool: "source-map",
  module: {
